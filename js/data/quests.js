...
export const QUESTS = [
  ...
  {id:'q0-1',ch:0,type:'tutorial',title:'新人獵人的第一課',client:'訓練所教官',
    ...
    goal:'完成新手訓練',mons:['image023'],turns:0,reward:{herb:2,image023n:1,iron:1},exp:5},

  /* ---------- 第一章 古代樹森林 ---------- */
  {id:'q1-1',ch:1,type:'hunt',title:'森林裡的搶匪',client:'古代樹森林調查員',
    text:'「搔鳥把營地的補給物資叼走了，還在附近大搖大擺！\n　牠不強，但會丟石頭，記得看清楚牠要打哪裡再出手。」',
    mons:['image023'],turns:15,reward:{herb:2,iron:1},exp:10},
  {id:'q1-3',ch:1,type:'hunt',title:'貪吃的大豺',client:'糧食補給班',
    text:'「大兇豺龍把我們曬的肉乾整排吞了！\n　牠吃飽會膨脹回血，別讓牠吃太多。」',
    mons:['image015'],turns:15,reward:{rawmeat:2,iron:1},exp:12},
  {id:'q1-4',ch:1,type:'capture',title:'狗頭的首領',client:'生態研究班',
    text:'「想研究大兇顎龍的麻痺牙，需要一隻活的。\n　打到牠開始跛腳（HP 30% 以下）再用陷阱，千萬別打死了。」',
    mons:['image016'],turns:16,reward:{web:2,iron:1},exp:14},
  ...
  {id:'q3-1',ch:3,type:'hunt',title:'樹上的雷光',client:'陸珊瑚調查員',
    ...
    mons:['image018'],turns:15,reward:{bug:2,honey:1},exp:30},
  ...
  {id:'q3-U',ch:3,type:'hunt',urgent:true,req:5,title:'【緊急】滅盡之刺',client:'調查團團長',
    ...
    mons:['image025'],turns:26,reward:{crystal:3,powder:2},exp:80},
  ...
  {id:'q4-2',ch:4,type:'hunt',title:'異界的訪客',client:'龍結晶調查員',
    text:'「龍結晶之地出現了從沒見過的巨獸，調查團叫牠異次元生物。\n　牠會召喚流星和落雷，隨時注意紅色格子。」',
    mons:['image033'],turns:26,reward:{crystal:2,iron:2},exp:60},
  ...
  {id:'q4-5',ch:4,type:'seq',title:'爆炸連鎖',client:'工房老闆',
    ...
    mons:['image017','image009'],turns:30,hpMul:.75,reward:{powder:3,crystal:1},exp:70},
